...
public class TreeDemo extends JPanel
    ...
    public TreeDemo() {
        ...
        ImageIcon Night = new ImageIcon(TreeDemo.class.getResource("middle.gif"));
        DefaultTreeCellRenderer renderer = new DefaultTreeCellRenderer();
        renderer.setClosedIcon(Night);
        renderer.setOpenIcon(Night);
    ...
    public void valueChanged(TreeSelectionEvent e) {
        ...
        Homework1.Node night = (Homework1.Node)nodeInfo;
        Homework1.inorder(night);
        htmlPane.setText(night.key.toString());

        if(night.left != null || night.right != null){
            htmlPane.setText("" + Homework1.calculate(night));
        }
